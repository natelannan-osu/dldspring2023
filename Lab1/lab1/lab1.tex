...
\lhead{OSU ECEN 3233 - Logic Design - Spring 2023}
\rfoot{\LaTeX}


% ----- Identifying Information -----------------------------------------------
\newcommand{\myassignment}{Lab 1: Using Testbenches More Effectively}
\newcommand{\myduedate}{Assigned: Monday 2/06 Due \textbf{Friday 2/24} (midnight)}
...
the files and/or lab report. Your code should be
